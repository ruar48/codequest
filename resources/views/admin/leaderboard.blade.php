...
<!-- Context-aware Leaderboards CSS -->
<style>
/* === Global Theme === */
...
/* === Badges for Points/Stars === */
.badge-points { background-color: #facc15; color: #1c1c1c; font-weight: 600; }
.badge-stars { background-color: #ffea80; color: #1c1c1c; font-weight: 600; }
</style>
                ...
                <table class="table table-hover table-striped table-bordered text-center" id="LeaderBoardsTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge-points">{{ $player->total_points }}</span></td>
                            <td><span class="badge-stars">{{ $player->total_stars }}</span></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
