...
.small-box.primary { background: linear-gradient(90deg, #facc15, #ffea80); color: #1c1c1c; }
.small-box.success { background: linear-gradient(90deg, #27ae60, #6fcf97); }
.small-box.warning { background: linear-gradient(90deg, #f1c40f, #f9d463); color: #1c1c1c; }
.small-box.danger { background: linear-gradient(90deg, #e74c3c, #f08080); }
